              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1">تعتمد المنصة نظام عمولة المنصة بنسبة 2.5% من قيمة المشروع، والذي يمثل عمولة المنصة. بعد دفع عمولة المنصة، تكون المعاملات المالية مباشرة بين الأطراف.</p>
                  </div>
                  <div>
