                    ...
                    {currentCompanyNda.status === 'signed' ? (
                      ...
                      <div className="flex items-center mb-2">
                        ...
                        <p className="text-blue-700 font-medium">
                          لقد قمت بتوقيع اتفاقية عدم الإفصاح وننتظر رائد الأعمال لإكمال بياناته.
                        </p>
                      </div>
                    ) : (
                      <div className="flex items-center mb-2">
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="text-sm text-blue-800">
                            ...
                            <ul className="list-disc list-inside space-y-1 text-blue-700">
                              <li>✅ تم إكمال بياناتك وتوقيع اتفاقية عدم الإفصاح</li>
                              <li>⏳ ننتظر رائد الأعمال لإكمال بياناته</li>
                              <li>📧 سيتم إرسال اتفاقية السرية النهائية عبر صادق بعد إكمال جميع البيانات</li>
                            </ul>
                          </div>
                        </div>
                      </div>
