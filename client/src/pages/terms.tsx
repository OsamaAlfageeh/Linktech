    ...
    <div className="container mx-auto py-8 px-4 md:px-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm">
        <div className="prose prose-lg max-w-none">
          ...
          <p>تطبق المنصة نظام عمولة بنسبة 2.5% من قيمة المشروع، تدفع كعمولة المنصة من قبل رائد الأعمال عند قبول عرض إحدى الشركات. يخصم هذا المبلغ من القيمة الإجمالية للمشروع.</p>
