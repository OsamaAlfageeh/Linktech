      ...
      <div className="container mx-auto py-8 px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          <Card className="shadow-md hover:shadow-lg transition-shadow border-t-4 border-t-primary">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-muted p-4 rounded-lg">
                ...
                <p className="text-muted-foreground">
                  عند قبول عرضك ودفع العميل لعمولة المنصة، تُكشف معلومات التواصل لكلا الطرفين لبدء التواصل المباشر والاتفاق النهائي.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-md hover:shadow-lg transition-shadow border-t-4 border-t-purple-600">
            ...
            <CardContent className="space-y-4">
              <div className="bg-muted p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-purple-600">عمولة المنصة ٢.٥٪ من قيمة المشروع</h3>
                <p className="text-muted-foreground">
                  عند قبول عرضك، يدفع العميل عمولة المنصة بقيمة ٢.٥٪ من إجمالي قيمة المشروع. هذه العمولة ضمان لجدية العميل ومؤشر على الالتزام بالتعاقد.
                </p>
              </div>
              
              <div className="bg-muted p-4 rounded-lg">
                <h3 className="font-semibold mb-2 text-purple-600">خصم عمولة المنصة من قيمة المشروع</h3>
                <p className="text-muted-foreground">
                  يتم خصم قيمة عمولة المنصة المدفوعة من القيمة الإجمالية للمشروع. فمثلاً، إذا كانت قيمة المشروع ١٠٠٠٠ ريال ودفع العميل عمولة المنصة بقيمة ٢٥٠ ريال، فإن المبلغ المتبقي للدفع هو ٩٧٥٠ ريال.
                </p>
              </div>
              ...
              <div className="bg-muted p-4 rounded-lg">
                ...
                <p className="text-muted-foreground">
                  تعتبر قيمة عمولة المنصة المدفوعة هي عمولة المنصة. لا توجد رسوم إضافية على الشركات أو العملاء بعد ذلك. التعاقد والدفعات اللاحقة تتم مباشرة بين الطرفين.
                </p>
              </div>
              ...
              <div className="bg-muted p-4 rounded-lg">
                ...
                <p className="text-muted-foreground">
                  في حالة إلغاء المشروع من قبل العميل بعد دفع عمولة المنصة ولأسباب غير متعلقة بالشركة، تحتفظ المنصة بعمولة المنصة. وفي حال إلغاء المشروع من قبل الشركة، تُرد عمولة المنصة للعميل.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-md">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-muted p-4 rounded-lg">
                  <h3 className="font-semibold mb-2 text-green-600">كشف البيانات فقط بعد دفع عمولة المنصة</h3>
                  <p className="text-muted-foreground">
                    تظهر بيانات التواصل الخاصة بالشركة للعميل فقط بعد موافقته على العرض ودفع عمولة المنصة، مما يضمن جدية التعامل.
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <div className="mb-12">
          ...
          <Accordion type="single" collapsible className="w-full max-w-3xl mx-auto">
            <AccordionItem value="item-1">
              ...
              <AccordionContent>
                تضمن المنصة جدية العملاء من خلال نظام عمولة المنصة الذي يتطلب من العميل دفع 2.5% من قيمة المشروع قبل الكشف عن معلومات التواصل. يشير هذا الالتزام المالي إلى جدية العميل واهتمامه بالمضي قدماً في المشروع.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                نعم، يمكنك رفض المشروع حتى بعد قبول العرض، لكن يجب أن يكون ذلك قبل بدء العمل الفعلي. في هذه الحالة، سيتم رد عمولة المنصة للعميل، وقد يؤثر ذلك على تقييم شركتك في المنصة.
              </AccordionContent>
            </AccordionItem>
            
            <AccordionItem value="item-3">
              <AccordionTrigger>ما هي آلية الدفع بعد دفع عمولة المنصة؟</AccordionTrigger>
              <AccordionContent>
                بعد دفع عمولة المنصة وكشف بيانات التواصل، تتم جميع المعاملات المالية اللاحقة مباشرة بين شركتك والعميل دون تدخل المنصة. يمكنكما الاتفاق على جدول زمني للدفعات وطريقة الدفع المناسبة لكما.
              </AccordionContent>
            </AccordionItem>
