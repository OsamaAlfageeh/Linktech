  ...
  const faqData: FAQCategory[] = [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "التسجيل في المنصة وإنشاء حساب مجاني تماماً. تقوم المنصة بتحصيل عمولة بنسبة 10% فقط عند إتمام التعاقد بين رائد الأعمال والشركة. لا توجد أي رسوم خفية أو تكاليف إضافية."
        },
      ]
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: "عند اختيار إحدى الشركات، تقوم بدفع 10% من قيمة المشروع كعربون من خلال بوابات الدفع المتوفرة في المنصة. يتم الاحتفاظ بهذا المبلغ لدينا كضمان حتى اكتمال المشروع. بعد ذلك، يمكنك التواصل المباشر مع الشركة والاتفاق على طريقة دفع باقي المبلغ."
        },
        {
          id: "project-disputes",
