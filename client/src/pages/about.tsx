...
const AboutPage = () => {
  return (
    <>
      <Helmet>
        <title>من نحن | لينكتيك</title>
        <meta name="description" content="تعرف على قصة لينكتيك ورؤيتنا ورسالتنا في ربط أصحاب المشاريع مع الشركات التقنية في المملكة العربية السعودية" />
      </Helmet>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 md:p-8 mb-12">
            ...
            <div className="space-y-4 text-neutral-700">
              <p>
                بدأت قصة لينكتيك من ملاحظة فجوة كبيرة في سوق التقنية السعودي - حيث يواجه أصحاب الأفكار والمشاريع صعوبة في العثور على شركات تطوير موثوقة تناسب احتياجاتهم، بينما تكافح شركات التطوير للوصول إلى العملاء المناسبين.
              </p>
              <p>
              ...
              <p>
                اليوم، نفخر بأن لينكتيك أصبحت المنصة الرائدة في المملكة العربية السعودية التي تجمع بين أصحاب المشاريع والشركات التقنية من خلال نظام توافق ذكي وآمن.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 md:p-8 mb-12">
            ...
            <p className="text-neutral-700 mb-8">
              يضم فريق لينكتيك نخبة من المتخصصين في مجالات تطوير البرمجيات، وتجربة المستخدم، والذكاء الاصطناعي، وريادة الأعمال. نحن نجمع بين الخبرة العميقة والشغف بتمكين الابتكار التقني في المملكة العربية السعودية.
            </p>
          ...
          <div className="bg-gradient-to-r from-primary/90 to-primary/70 text-white rounded-xl shadow-md p-6 md:p-8">
            <div className="text-center max-w-3xl mx-auto">
              ...
              <p className="mb-8 text-white/80">
                سواء كنت صاحب مشروع تبحث عن شركة مناسبة، أو شركة تطوير تبحث عن مشاريع جديدة، انضم إلينا اليوم واكتشف كيف يمكن للينكتيك مساعدتك في تحقيق أهدافك.
              </p>
