...
const HowItWorksPage = () => {
  return (
    <>
      <Helmet>
        <title>كيف يعمل موقعنا | تِكلينك</title>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-center mb-8">كيف يعمل تِكلينك</h1>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 md:p-8 mb-8">
            <h2 className="text-2xl font-bold mb-6 text-primary">مميزات تِكلينك</h2>
          ...
          <div className="bg-gradient-to-r from-primary/90 to-primary/70 text-white rounded-xl shadow-md p-6 md:p-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="mb-8 text-white/80">
                سواء كنت صاحب مشروع تقني طموح أو شركة تطوير متخصصة، انضم إلينا اليوم واستفد من ميزات منصة تِكلينك لتحقيق أهدافك.
              </p>
