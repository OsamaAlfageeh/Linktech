...
const sender = new Sender("noreply@techlink.example", "تِكلينك");
      ...
      .setHtml(`
        <div dir="rtl" style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto;">
          <div style="background-color: #f8f9fa; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
            <h1 style="color: #2563eb; margin: 0; font-size: 24px;">تِكلينك</h1>
          ...
          <div style="background-color: #ffffff; padding: 20px; border-radius: 0 0 8px 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            <p>لقد تلقينا طلباً لإعادة تعيين كلمة المرور لحسابك في منصة تِكلينك. يرجى النقر على الزر أدناه لإعادة تعيين كلمة المرور الخاصة بك:</p>
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eaeaea; font-size: 14px; color: #666;">
              <p>مع تحيات،<br>فريق منصة تِكلينك</p>
            </div>
          </div>
        </div>
      `)
...
لقد تلقينا طلباً لإعادة تعيين كلمة المرور لحسابك في منصة تِكلينك.
      ...
      .setHtml(`
        <div dir="rtl" style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background-color: #ffffff; padding: 20px; border-radius: 0 0 8px 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            <p>نود إعلامك أنه تم تغيير كلمة المرور لحسابك في منصة تِكلينك بنجاح.</p>
...
نود إعلامك أنه تم تغيير كلمة المرور لحسابك في منصة تِكلينك بنجاح.
    ...
    const emailParams = new EmailParams()
      ...
      .setHtml(`
        <div dir="rtl" style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background-color: #ffffff; padding: 20px; border-radius: 0 0 8px 8px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            <h2 style="color: #1f2937; margin-top: 0;">مرحباً بك في منصة تِكلينك</h2>
            
            <p style="margin-bottom: 25px;">مرحباً ${name}،</p>
            
            <p>شكراً لانضمامك إلى منصة تِكلينك - المنصة الرائدة في ربط رواد الأعمال بشركات تطوير البرمجيات في المملكة العربية السعودية.</p>
...
شكراً لانضمامك إلى منصة تِكلينك - المنصة الرائدة في ربط رواد الأعمال بشركات تطوير البرمجيات في المملكة العربية السعودية.
