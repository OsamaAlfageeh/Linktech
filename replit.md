...
- July 12, 2025: إنشاء نظام العملاء المميزين المنفصل
  - تم إنشاء جدول featured_clients منفصل بدلاً من استخدام الشركات الموثقة
  - أضيف صفحة إدارة العملاء المميزين في لوحة الإدارة (/admin/featured-clients-management)
  - تم إضافة APIs كاملة لإدارة العملاء المميزين (إضافة، تحديث، حذف، عرض)
  - تم تحديث مكون FeaturedClients ليعمل مع البيانات الجديدة
  - أضيف رابط "العملاء المميزون" في قائمة تنقل لوحة الإدارة
