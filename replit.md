...
- June 26, 2025: إصلاح شامل لنظام البيانات الشخصية وتوقيع اتفاقيات عدم الإفصاح (NDA)
  ...
  - تم إصلاح إعادة تحميل البيانات بعد الحفظ باستخدام invalidateQueries
  - أضيف قسم أخضر يظهر عند اكتمال البيانات مع زر للانتقال لتوقيع اتفاقيات NDA
  - تم حل مشكلة عدم ظهور خيارات توقيع NDA بعد إكمال البيانات الشخصية
